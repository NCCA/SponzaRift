...
CONFIG += console
# Oculus SDK
ORLOCATION=/Users/jmacey/teaching/OculusRift/OculusSDK/
INCLUDEPATH+=$$ORLOCATION/LibOVR/Include/
INCLUDEPATH+=$$ORLOCATION/LibOVR/Src/
INCLUDEPATH+=$$ORLOCATION/LibOVR/Src/CAPI
INCLUDEPATH+=$$ORLOCATION/LibOVR/Src/CAPI/GL


INCLUDEPATH +=./include

LIBS +=  -L$$ORLOCATION/LibOVR/Lib/Mac/Debug/ -lovr
LIBS += -framework CoreFoundation -framework ApplicationServices -framework IOKit
